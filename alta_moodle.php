...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if($username != $usuario){
        echo "No tiene permisos para solicitar esta acción en otro usuario";
        exit;
    }

   
    // Escribir en el archivo de gestiones si la contraseña nueva coincide con la confirmación
    $file_path = '/var/www/html/login/formularios/gestiones/alta_moodle.txt';
    $data = "$usuario:$contrasena:$correo:$nombre:$apellido$"; // Formato: usuario_de_la_sesion:contraseña_antigua:contraseña_nueva
